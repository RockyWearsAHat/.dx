...
exports.getBlockPresentationMeta = getBlockPresentationMeta;
exports.applyBlockViewPresentation = applyBlockViewPresentation;
...
function getBlockPresentationMeta(block) {
...
function applyBlockViewPresentation(view, block) {
    if (!view)
        return;
