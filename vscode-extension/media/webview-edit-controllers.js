...
exports.BlockSourceController = exports.InlineCssSurfaceController = void 0;
class InlineCssSurfaceController {
    constructor(options) {
    ...
    ensureInlineCssSurface(source) {
        ...
        if (editor) {
            editor.addEventListener('input', () => {
                const cssText = this.options.mergeScopedCssForSelector(this.state.baseCssText, this.state.selector, editor.value);
...
exports.InlineCssSurfaceController = InlineCssSurfaceController;
class BlockSourceController {
    constructor(options) {
        this.options = options;
    }
    hasPendingBlockSourceChanges(source) {
        ...
        const nextSource = this.options.buildRawSourceFromEditorParts(this.options.getHeaderSourceFromEditor(source), this.options.getRawSourceFromEditor(source.value), source.dataset.footerSource || '');
...
exports.BlockSourceController = BlockSourceController;
