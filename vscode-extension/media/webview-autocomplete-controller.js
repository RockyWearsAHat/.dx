...
exports.getLineContextFromValue = exports.DEFAULT_BLOCK_AUTOCOMPLETE = exports.computeNextSelectedIndex = exports.computeAutocompleteSuggestions = void 0;
exports.createAutocompleteController = createAutocompleteController;
const webview_autocomplete_core_js_1 = require("./webview-autocomplete-core.js");
Object.defineProperty(exports, "computeAutocompleteSuggestions", { enumerable: true, get: function () { return webview_autocomplete_core_js_1.computeAutocompleteSuggestions; } });
Object.defineProperty(exports, "computeNextSelectedIndex", { enumerable: true, get: function () { return webview_autocomplete_core_js_1.computeNextSelectedIndex; } });
Object.defineProperty(exports, "DEFAULT_BLOCK_AUTOCOMPLETE", { enumerable: true, get: function () { return webview_autocomplete_core_js_1.DEFAULT_BLOCK_AUTOCOMPLETE; } });
Object.defineProperty(exports, "getLineContextFromValue", { enumerable: true, get: function () { return webview_autocomplete_core_js_1.getLineContextFromValue; } });
const webview_autocomplete_history_js_1 = require("./webview-autocomplete-history.js");
...
function createAutocompleteController(options) {
    ...
    const blockAutocomplete = Array.isArray(config.blockAutocomplete)
        ...
        : webview_autocomplete_core_js_1.DEFAULT_BLOCK_AUTOCOMPLETE;
    ...
    const raf = typeof config.requestAnimationFrame === 'function'
        ...
        : (callback) => callback();
    const history = (0, webview_autocomplete_history_js_1.createAutocompleteHistory)(storage, storageKey);
    const state = {
        textarea: null,
        suggestions: [],
        selectedIndex: 0,
    ...
    function getAutocompleteSuggestions(textarea, forceOpen = false) {
        ...
        const context = (0, webview_autocomplete_core_js_1.getLineContextFromValue)(textarea.value || '', textarea.selectionStart || 0);
        const runtimeSchema = (0, webview_autocomplete_history_js_1.buildAutocompleteSchemaFromHeaders)(collectAutocompleteHeaders());
        const schema = (0, webview_autocomplete_history_js_1.mergeAutocompleteSchemas)(runtimeSchema, history.getSchema());
        return (0, webview_autocomplete_core_js_1.computeAutocompleteSuggestions)({
            context,
            forceOpen,
            blockAutocomplete,
    ...
    function renderGhostText(textarea, mirrorEl) {
        if (!mirrorEl || !state.suggestions.length)
            return;
    ...
    function updateAutocompleteSelection(delta) {
        ...
        state.selectedIndex = (0, webview_autocomplete_core_js_1.computeNextSelectedIndex)(state.selectedIndex, delta, state.suggestions.length);
        const textarea = state.textarea;
        const { menuEl, mirrorEl } = getAutocompleteEls(textarea);
        renderGhostText(textarea, mirrorEl);
        if (menuEl) {
