//! Base64 (RFC 4648) encoding and decoding.
//!
//! The platform needs base64 in exactly two places — the MCP server encodes captured
//! images into tool results, and the DevTools client decodes the frames the browser hands
//! back — so the codec is owned outright here rather than taken as a dependency, and both
//! callers share it.
