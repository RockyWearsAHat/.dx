import { saveDocumentSourceByRelativePath } from './src/doc-service.js';
import { createDatabase } from './src/database.js';
import { resolveDocDbPath } from './src/global-db-path.js';
...
const { readDocArchive } = await import('./src/doc-archive.js');
