...
test('doc-binary normalizes non-string block type to paragraph and preserves mixed list item objects', () => {
  const doc = {
    ...
    meta: {},
    blocks: [
      { type: 42, id: 'x', text: 'fallback paragraph text' },
      {
        type: 'bulleted-list',
        id: 'mix',
        items: [{ text: 'object item' }, 'string item', null, { text: '' }],
      },
    ],
  };
